package com.example.hardware_softwareshopping.exceptions;
...
public class ApiExceptionResponse extends Exception {
    ...
    @Builder
    public ApiExceptionResponse(String message, HttpStatus status, List<String> errors, String message1) {
        super(message);
        this.status = status;
        this.errors = errors;
